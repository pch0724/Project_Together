...
public class ItemDAO {
	...
	private void init() {
		...
		itemList.add(new Items(1, "닭고기육포", 5500, "./img/닭고기육포.PNG",
				"자연에서 온 신선하고 안전한 재료" + "\n 고담백 저지방 다이어트 영양간식!",
				"간식"));
		...
		itemList.add(new Items(4, "우드스틱", 5000, "./img/우드스틱.PNG",
				"100% 친환경 커피나무로 만든" + "\n  치석제거가 탁월한 커피 스틱입니다.",
				"장난감"));

		itemList.add(new Items(5, "터그볼", 6900, "./img/터그볼.PNG",
				"순면 재질의 물수있는 끈이 있어 " + "\n  이갈이와 이청소를 동시에 해결!",
				"장난감"));
		...
		itemList.add(new Items(9, "눈물자국시트30매", 3000, "./img/눈물자국시트30매.PNG",
				"잡균제거와 눈물자국 제거" + "\n 시원하게 한번에 OK!",
				"위생"));

		itemList.add(new Items(10, "한장쓱패드400매", 28650, "./img/한장쓱패드400매.PNG",
				"깔끔한 소형견을 위한" + "\n 한장쓱패드!",
				"위생"));
		...
		itemList.add(new Items(12, "X자하네스", 18900, "./img/X자 하네스.PNG",
				"100% 국내재료로 생산" + "\n 편안함에 신축성을 더함!",
				"산책"));
