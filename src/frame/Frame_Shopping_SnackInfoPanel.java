...
public class Frame_Shopping_SnackInfoPanel extends JPanel {
	...
	public Frame_Shopping_SnackInfoPanel(Items item, MyInfo m, CartDAO c, SellDAO history) {
		this.m = m;
		this.c = c;
		this.item = item;
		...
		backBtn.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				Frame_Base.getInstance(new Frame_Shopping_Snack(m, c, history));
			}
		});
		//하단버튼
